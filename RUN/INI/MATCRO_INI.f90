...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  !LONLAT_FILE="/home/tnakagawa/MATCRO/Baye2/INPUT/Coordinate/"//trim(POINT)//"_lonlat.csv"
  ...
  DO YEAR = STYR,ENYR
   ...
   IF(MODE=="ONE")THEN
      CALL RDCLIM(INTMN,CLIM_HEAD,COUNTRY,REGION,'tmin ',IRR_NAME,SEASON,YEAR,CLIM_FOOT,NLON,NLAT,365)
      !print *,"TMN OK"
      CALL RDCLIM(INTMX,CLIM_HEAD,COUNTRY,REGION,'tmax ',IRR_NAME,SEASON,YEAR,CLIM_FOOT,NLON,NLAT,365)
      !print *,"TMX OK"
      CALL RDCLIM(INPRC,CLIM_HEAD,COUNTRY,REGION,'prc  ',IRR_NAME,SEASON,YEAR,CLIM_FOOT,NLON,NLAT,365)
      !print *,"PRC OK"
      CALL RDCLIM(INRSD,CLIM_HEAD,COUNTRY,REGION,'rsd  ',IRR_NAME,SEASON,YEAR,CLIM_FOOT,NLON,NLAT,365)
      !print *,"RSD OK"
      CALL RDCLIM(INSHM,CLIM_HEAD,COUNTRY,REGION,'shm  ',IRR_NAME,SEASON,YEAR,CLIM_FOOT,NLON,NLAT,365)
      !print *,"SHM OK"
      CALL RDCLIM(INWND,CLIM_HEAD,COUNTRY,REGION,'wnd  ',IRR_NAME,SEASON,YEAR,CLIM_FOOT,NLON,NLAT,365)
      !print *,"WND OK"
      CALL RDCLIM(INPRS,CLIM_HEAD,COUNTRY,REGION,'prs  ',IRR_NAME,SEASON,YEAR,CLIM_FOOT,NLON,NLAT,365)
      !print *,"PRS OK"
      INOZN=0.0D0
