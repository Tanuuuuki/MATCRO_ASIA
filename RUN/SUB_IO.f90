SUBROUTINE RDSET(MODE,POINT,STYR,ENYR,STDOY,ENDOY,POINTLON,POINTLAT,TRES,clmTRES,WEST,EAST,NORTH,SOUTH,WERES,NSRES,IRR,&
...
!  print *,"koko"
  ...
  ELSE
     ...
     READ(10,'(A15,A200)')BUF15,CDI_FILE
...
SUBROUTINE RDCLIM(VAR,HEAD,PREF,CLIMNAME,IYEAR,FOOT,NLON,NLAT,DAT_NTIME)
   ...
   !print *, YYYY
   FILE=TRIM(ADJUSTL(HEAD))//TRIM(ADJUSTL(PREF))//'/'//TRIM(ADJUSTL(YYYY))//'_'//TRIM(ADJUSTL(CLIMNAME))//'_'//TRIM(ADJUSTL(PREF))//TRIM(ADJUSTL(FOOT))
